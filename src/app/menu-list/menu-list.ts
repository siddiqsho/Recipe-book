...
export class MenuList {
   recipes= [
  {
    ...
    description: "С появлением в магазинах готовых листов для лазаньи готовить это вкусное блюдо в домашних условиях стало намного проще. Есть много рецептов приготовления классической лазаньи. Предлагаем сделать запеканку с мясной начинкой, как в пасте болоньезе. А для мягкости еще и добавить сыр. Получится очень аппетитное сочетание томатного и сливочного вкусов.",
    ingredients: [
